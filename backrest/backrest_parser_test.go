...
func TestGetMetrics(t *testing.T) {
	...
	templateMetrics := `# HELP pgbackrest_exporter_backup_database_size Database size in backup by stanza and backup type.
...
# HELP pgbackrest_exporter_backup_duration Backup duration in seconds by stanza and backup type.
...
# HELP pgbackrest_exporter_backup_info Backup info by stanza and backup type.
...
# HELP pgbackrest_exporter_backup_repo_backup_set_size Repo set size in backup by stanza and backup type.
...
# HELP pgbackrest_exporter_backup_repo_backup_size Repo size in backup by stanza and backup type.
...
# HELP pgbackrest_exporter_backup_size Backup size by stanza and backup type.
...
# HELP pgbackrest_exporter_repo_status Current repo status by stanza.
...
# HELP pgbackrest_exporter_wal_archive_status WAL archive status by stanza.
