...
case "${MODE}" in
    ...
    *)
    ...
    '^pgbackrest_backup_repo_since_last_completion_seconds{.*,repo_key="1",.*}|3'
    '^pgbackrest_backup_repo_since_last_completion_seconds{.*,repo_key="2",.*}|3'
    '^pgbackrest_backup_repo_last_duration_seconds{.*,repo_key="1",.*}|3'
    '^pgbackrest_backup_repo_last_duration_seconds{.*,repo_key="2",.*}|3'
    ...
    '^pgbackrest_stanza_backup_complete_bytes{.*} 0$|1'
    '^pgbackrest_stanza_backup_repo_complete_bytes{repo_key="1",.*} 0$|1'
    '^pgbackrest_stanza_backup_repo_complete_bytes{repo_key="2",.*} 0$|1'
    '^pgbackrest_stanza_backup_repo_total_bytes{repo_key="1",.*} 0$|1'
    '^pgbackrest_stanza_backup_repo_total_bytes{repo_key="2",.*} 0$|1'
    '^pgbackrest_stanza_backup_total_bytes{.*} 0$|1'
    '^pgbackrest_stanza_backup_lock_status{.*} 0$|1'
    '^pgbackrest_stanza_restore_complete_bytes{.*} 0$|1'
    '^pgbackrest_stanza_restore_total_bytes{.*} 0$|1'
    '^pgbackrest_stanza_restore_lock_status{.*} 0$|1'
